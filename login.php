    ...
    <div class="col-md-4" style="margin-top:20px;">
      ...
      <div class="card-header bg-info">
        <div class="row bg-info">        
          <a class="col-sm-6 bg-light text-dark btn btn-sm" href="admin/login.php" style="text-align:center;width:50%;"><h5>Admin</h5></a>
          <a class="col-sm-6 bg-info text-light btn btn-sm" style="text-align:center;width:50%;"><h5>Teacher</h5></a>
        </div>
        </div>
        <div class="card-body">
