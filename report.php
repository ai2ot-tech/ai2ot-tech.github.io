...
<head>
  <style>
    ...
    #header { position: fixed; left: 0px; top: -150px; right: 0px; height: 100px; background-color: Green; text-align: center; }
    #footer { position: fixed; left: 0px; bottom: -160px; right: 0px; height: 50px; background-color: lightblue; }
...
<body>
  <div id="header">
  	<h3>SRI VIGNANA JYOTHI ENGLISH MEDIUM SCHOOL</h3>
  	<h3>RAMANAGAR, KARATAGI-583229</h3>
  </div>
  <div id="watermark">
            <img src="C:\xampp\htdocs\tutorial\SAM\admin\docs\School_logo.jpg" height="100%" width="100%" />
        </div>
  <div id="footer">
    <p class="page">Page </p>
  </div>
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="0">
			        <tr>
			        	<td>
							...
							<tr>
			        			<td colspan="4" border="1"><b>Date - '.$row["attendance_date"].'</b></td>
			        		</tr>
			        			<tr>
	...
	if($_GET["action"] == "student_report")
	{
		if(isset($_GET["student_id"], $_GET["from_date"], $_GET["to_date"]))
		{
			...
			foreach($result as $row)
			{
				...
				<p>&nbsp;</p>
				<h3 align="center"></h3><br><br><h3></h3>
				<table width="100%" border="0" cellpadding="5" cellspacing="0">
			        <tr>
